...
export default function ExploreSection() {
  ...
  return (
      <div>
          <a href={routeLink} target="_blank" class="flex hover:underline hover:text-blue-700 hover:cursor-pointer justify-center items-center gap-4 mb-8 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-5xl">
              Explore Kooler Jo
